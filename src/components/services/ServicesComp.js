  ...
  let services = [
    {
      ...
      subServices: [
        ...
        },
        {
          ...
          desc: "Data Loss Prevention (DLP) is the practice of detecting and preventing data breaches, exfiltration, or unwanted destruction of sensitive data. Organizations use DLP to protect and secure their data and comply with regulations.",
          features: [
            {
    ...
    },
    {
      ...
      subServices: [
        ...
        },
        {
          ...
          desc: "A secure code review is a specialized task involving manual and/or automated review of an application's source code in an attempt to identify security-related weaknesses (flaws) in the code. A secure code review does not attempt to identify every issue in the code, but instead looks to provide insight into what types of problems exist and to help the developers of the application understand what classes of issues are present. The goal is to arm the developers with information to help them make the application's source code more sound and secure.",
          advantages: [
            "AUTHENTICATION",
            "AUTHORIZATION",
            "SESSION MANAGEMENT",
        ...
        },
        {
          ...
          desc: "Effective security is about balancing accessibility with data protection. Too much of either can compromise your systems or your processes. Luckily Microsoft has provided enhanced capabilities to both protect your privacy while allowing your team to limitlessly collaborate. Learn more about Microsoft Office 365 Hardening below.",
          features: [
            {
        ...
        },
        {
          ...
          desc: "A cybersecurity consultant doesn’t work for one company exclusively, but rather is hired by a client to test the organization’s cybersecurity measures, and then design and implement a better defense. These consultants are sometimes known by different names, such as:",
          features: [
      ...
      subServices: [
        {
          ...
          desc: "IT architecture is a key component in supporting business goals and objectives: ",
          features: [
            {
              title:
      ...
      subServices: [
        {
          ...
          desc: "What is digital forensics readiness? Digital forensics readiness is the ability of organizations to respond quickly and collect digital evidence related to a security incident with minimal cost or interruption to the ongoing business.",
          features: [
            {
              title: "1. ",
              content:
        ...
        },
        {
          ...
          desc: "web application audit is to review an application’s codebase to determine whether the code is doing something it shouldn’t. Audits may also evaluate whether code can be manipulated to do something inappropriate and whether the apps may be communicating sensitive data in the clear. A superior web application audit should identify whether developers have implemented appropriate security precautions.Typically, a web application audit will include “white box” automated testing that examines code from the inside, and “black box” testing that examines applications from the outside while in production.",
          advantages: [
